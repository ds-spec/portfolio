  ...
  return (
    <>
      <div
        ...
        className="flex flex-col justify-between items-center overflow-hidden bg-white"
      >
        {["IMPACTFUL", "DESIGN", "IS THE", "DESIGN", "THAT", "WORKS!"].map(
          (text, index) => (
            <span
              key={index}
              style={{ zIndex: 4 }}
              className="relative text-[40vw] font-anzo-italic leading-[500px] animated-text drop-shadow-md"
      ...
      <div className="flex flex-col items-center">
        ...
        <hr className="w-[35vw] mt-10 h-[1px] bg-black" />
      </div>
    </>
  );
};
